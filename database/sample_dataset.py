...
def load_sample_data(db: Database):
    ...
    classroom_warszawa = db.classrooms_table.add_classroom("Warszawa (07)")
    classroom_wroclaw = db.classrooms_table.add_classroom("Wrocław (08)")
    classroom_krakow = db.classrooms_table.add_classroom("Kraków (09)")
    classroom_lodz = db.classrooms_table.add_classroom("Łódź (05)")
    classroom_gdansk = db.classrooms_table.add_classroom("Gdańsk (04)")
    classroom_poznan = db.classrooms_table.add_classroom("Poznań (06)")
    classroom_seminar = db.classrooms_table.add_classroom("Sała seminaryjna (12)")
    classroom_komp = db.classrooms_table.add_classroom("Sała komputerowa (10)")
    classroom_konfer = db.classrooms_table.add_classroom("Sała konferencyjna (13)")
    classroom_proj = db.classrooms_table.add_classroom("Sała projektowa (11)")
    ...
    db.group_lessons_table.add_group_lesson(group_4s, i)
    ...
    db.group_lessons_table.add_group_lesson(group_4s, i)  # duplicates
